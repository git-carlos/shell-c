...
// milestone : parsing : tokenlist
typedef struct {
	int size;
	char **items;
} tokenlist;

// milestone : background processing : jobs
typedef struct {
	int flag;
	pid_t pid;
	tokenlist *cmd;
